...
// File format:
//   storeFile=/absolute/path/to/totalstore-release.jks
//   storePassword=...
//   keyAlias=totalstore
//   keyPassword=...
...
android {
    ...
    buildTypes {
        release {
            ...
            // Fall back to debug signing for local `flutter run --release` development.
            signingConfig = if (hasReleaseKeystore)
                signingConfigs.getByName("release")
            else
                signingConfigs.getByName("debug")
            // NOTE: minification/shrinking deferred to M4 release-hardening pass —
            // requires proguard-rules.pro with proper keep rules for Flutter, FCM,
            // dio, Sentry, signature, and any other reflection-using libraries.
        }
    }
}
