...
class UpdateService {
  ...
  static const String _appKey = 'rider';

  /// [manual] = true when the rider taps "Check for updates" — then we also give
  /// feedback when already up to date or when the check fails. Auto (startup)
  /// checks stay silent unless an update is available.
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.system_update, color: Colors.orange.shade700, size: 24),
            ),
