...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
  ...
  { key: 'API_BASE_URL', group: 'api_config', label: 'Primary API Base URL', type: 'url', defaultValue: 'https://store.saktech.org/api/v1' },
  { key: 'API_BACKUP_URL', group: 'api_config', label: 'Backup API Base URL', type: 'url', defaultValue: '' },
  { key: 'UPLOAD_BASE_URL', group: 'api_config', label: 'Upload / CDN Base URL', type: 'url', defaultValue: 'https://store.saktech.org' },
